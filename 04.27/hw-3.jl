...
# ╔═╡ 058405f6-ab75-4916-b1aa-495b6fb36228
md"""
|        |         |                                @ |
|:-------|:--------|---------------------------------:|
...
begin
    ...
    Markdown.parse("""
    ```math
    D_{1} = $(s(q10)) \\in [$(s(q10L)), $(s(q10U))]_{.95}
    ```
    ```math
    Q_{1} = $(s(q25)) \\in [$(s(q25L)), $(s(q25U))]_{.95}
    ```
    ```math
    Q_{2} = $(s(q50)) \\in [$(s(q50L)), $(s(q50U))]_{.95}
    ```
    ```math
    Q_{3} = $(s(q75)) \\in [$(s(q75L)), $(s(q75U))]_{.95}
    ```
    ```math
    D_{9} = $(s(q90)) \\in [$(s(q90L)), $(s(q90U))]_{.95}
    ```
    """)
end
...
md"""
```math
F(t) = \frac{1}{n} \cdot |{\set{x_i | x_i \leq t}}|
```
"""
